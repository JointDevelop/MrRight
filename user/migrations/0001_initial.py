# Generated by Django 2.2.17 on 2020-11-09 02:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phonenum', models.CharField(max_length=16, unique=True, verbose_name='手机')),
                ...
                ('location', models.CharField(choices=[('北京', '北京'), ('上海', '上海'), ('深圳', '深圳'), ('郑州', '郑州'), ('西安', '西安'), ('成都', '成都'), ('沈阳', '沈阳')], max_length=16, verbose_name='常居地')),
            ],
        ),
    ]
